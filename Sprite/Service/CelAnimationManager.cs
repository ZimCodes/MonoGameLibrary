...
namespace MonoGameLibrary.Sprite.Service
{
    /// <summary>
    ...
    public sealed partial class CelAnimationManager : Microsoft.Xna.Framework.GameComponent, ICelAnimationManager
    {
        ...
        /// <param name="framesPerSecond">Frame Rate to play back animation in frames per second</param>
        ...
        /// <summary>
        /// Pauses and starts an animation
        /// </summary>
        ...
        public void GoToFrame(string animationKey,int frame)
        {
            if (animations.ContainsKey(animationKey))
            {
                animations[animationKey].Frame = frame;
                animations[animationKey].Paused = true;
                animations[animationKey].LoopCount = 0;
            }
        }
